...
const NICHES: NicheCard[] = [
  {
    ...
    subtitle: {
      ru: 'Клиенты, сделки, оплата, возвраты',
      en: 'Clients, deals, payment, follow-up',
    },
    outcome: {
      ru: 'Вернуть ответ, дожать, закрыть на оплату',
      en: 'Get a reply, move the deal, close payment',
    },
    examples: [
      {
        ru: 'Клиент пропал после КП',
        en: 'Client disappeared after the proposal',
      },
      {
        ru: 'Надо мягко дожать оплату',
        en: 'Need to nudge payment politely',
      },
      {
        ru: 'Хочу вернуть интерес после молчания',
        en: 'Need to revive interest after silence',
      },
    ],
  },
  {
    ...
    subtitle: {
      ru: 'Конфликты, договорённости, сложные сообщения',
      en: 'Conflict, agreements, hard conversations',
    },
    outcome: {
      ru: 'Снять напряжение и вернуть контроль',
      en: 'Reduce tension and regain control',
    },
    examples: [
      {
        ru: 'Нужно ответить без ссоры',
        en: 'Need to answer without a fight',
      },
      {
        ru: 'Человек игнорирует сообщение',
        en: 'Someone ignores my message',
      },
      {
        ru: 'Надо договориться спокойно',
        en: 'Need to agree calmly',
      },
    ],
  },
  {
    ...
    subtitle: {
      ru: 'Дейтинг, бывшие, ревность, сближение',
      en: 'Dating, exes, tension, reconnection',
    },
    outcome: {
      ru: 'Вернуть контакт и интерес',
      en: 'Bring back contact and interest',
    },
    examples: [
      {
        ru: 'Хочу вернуть общение',
        en: 'I want to bring back the conversation',
      },
      {
        ru: 'Не понимаю, интересен ли я',
        en: 'I do not know if they are interested',
      },
      {
        ru: 'Нужно написать без давления',
        en: 'Need to write without pressure',
      },
    ],
  },
  {
    ...
    subtitle: {
      ru: 'Коллеги, начальство, фидбек',
      en: 'Colleagues, managers, feedback',
    },
    outcome: {
      ru: 'Ответить уверенно и сохранить позицию',
      en: 'Respond confidently and keep your position',
    },
    examples: [
      {
        ru: 'Нужно ответить руководителю',
        en: 'Need to reply to a manager',
      },
      {
        ru: 'Конфликт в рабочем чате',
        en: 'Conflict in a work chat',
      },
      {
        ru: 'Хочу отстоять свою позицию',
        en: 'Want to stand my ground',
      },
    ],
  },
  {
    ...
    subtitle: {
      ru: 'Любой другой контекст',
      en: 'Any other context',
    },
    outcome: {
      ru: 'Подстроить анализ под ситуацию',
      en: 'Adapt the analysis to the situation',
    },
    examples: [
      {
        ru: 'Свой случай без категории',
        en: 'My own case without a category',
      },
      {
        ru: 'Нужен универсальный разбор',
        en: 'Need a universal breakdown',
      },
      {
        ru: 'Сначала понять, что делать',
        en: 'Need to understand what to do first',
      },
    ],
  },
];
...
const GOALS: GoalCard[] = [
  {
    key: 'money',
    label: {
      ru: 'Закрыть на деньги',
      en: 'Close for money',
    },
    hint: {
      ru: 'Продажа, оплата, сделка',
      en: 'Sales, payment, deal',
    },
  },
  {
    key: 'reply',
    ...
    hint: {
      ru: 'Снять игнор и вернуть диалог',
      en: 'End silence and restart the chat',
    },
  },
  {
    key: 'revive',
    ...
    hint: {
      ru: 'Дожать, восстановить интерес',
      en: 'Re-engage and restore interest',
    },
  },
  {
    key: 'life',
    ...
    hint: {
      ru: 'Ответить лучше и спокойнее',
      en: 'Reply better and calmer',
    },
  },
  {
    key: 'custom',
...
const COPY = {
  ru: {
    ...
    heroBullets: [
      'Разобрать динамику диалога',
      'Показать 3 сильных ответа',
    ...
    analysisBlocks: [
      {
        title: 'Анализ',
        text: 'Интерес, риск игнора, баланс контроля, главная ошибка.',
      },
      {
        title: '3 ответа',
        text: 'Продающий, уверенный и мягкий вариант.',
      },
      {
        title: 'Стратегия',
        text: 'Что делать сейчас, если нет ответа, и когда лучше не писать.',
      },
    ],
    ...
    featureCards: [
      {
        icon: '01',
        title: {
          ru: 'Conversation Score',
          en: 'Conversation Score',
        },
        text: {
          ru: 'Показывает вероятность ответа, доверие и баланс контроля.',
          en: 'Shows reply probability, trust, and control balance.',
        },
      },
      {
        icon: '02',
        title: {
          ru: 'Best Next Replies',
          en: 'Best Next Replies',
        },
        text: {
          ru: 'Генерирует 3 сильных ответа для разных стратегий общения.',
          en: 'Generates 3 strong replies for different communication strategies.',
        },
      },
      {
        icon: '03',
        ...
        text: {
          ru: 'Даёт тайминг, паузу, follow-up и возврат контроля.',
          en: 'Gives timing, pause, follow-up, and control recovery.',
        },
      },
      {
        icon: '04',
        ...
        text: {
          ru: 'Показывает, насколько прогноз надёжен и где риск ошибки.',
          en: 'Shows how reliable the forecast is and where the risk is.',
        },
      },
    ],
    testimonials: [
      {
        quote: {
          ru: 'Это ощущается как дорогой продукт, а не просто генератор текста.',
          en: 'This feels like a premium product, not just a text generator.',
        },
        name: 'Maya',
        role: {
          ru: 'Фриланс-продажи',
      ...
      {
        quote: {
          ru: 'Сайт сразу понял мою проблему и дал ответ, который можно отправить.',
          en: 'The site understood my problem instantly and gave a sendable reply.',
        },
        name: 'Anton',
        role: {
          ru: 'Агентство',
      ...
      {
        quote: {
          ru: 'Появилось ощущение контроля в очень сложной переписке.',
          en: 'It gave me a real sense of control in a hard conversation.',
        },
        name: 'Daria',
        role: {
    ...
    faq: [
      {
        q: {
          ru: 'Это чат-бот?',
          en: 'Is this a chatbot?',
        },
        a: {
          ru: 'Нет. Это outcome engine: система, которая помогает улучшать исход разговора, а не просто писать текст.',
          en: 'No. It is an outcome engine: a system that helps improve the result of a conversation, not just write text.',
        },
      },
      {
        q: {
          ru: 'Почему только 3 бесплатных анализа?',
          en: 'Why only 3 free analyses?',
        },
        a: {
          ru: 'Потому что ReplyOS должен быстро показать ценность и мягко перевести пользователя в оплату.',
          en: 'Because ReplyOS should show value quickly and convert gently into payment.',
        },
      },
      {
        q: {
          ru: 'Можно ли использовать на русском?',
          en: 'Can I use it in Russian?',
        },
        a: {
          ru: 'Да. Интерфейс можно переключать вручную или через автоперевод.',
          en: 'Yes. The interface can switch manually or through auto translate.',
        },
      },
      {
        q: {
          ru: 'Можно ли сохранить историю?',
          en: 'Can I save history?',
        },
        a: {
          ru: 'Это логичный следующий шаг для Pro и Team, когда добавим авторизацию и базу.',
          en: 'That is the logical next step for Pro and Team once auth and storage are added.',
        },
      },
    ],
    pricing: [
      ...
      },
      {
        ...
        points: [
          ...
          {
            ru: 'Глубже психология',
            en: 'Deeper psychology',
          },
        ],
        accent: 'cyan',
      },
  ...
  en: {
    ...
    heroText:
      'ReplyOS shows what is really happening in the conversation and gives you the next move that changes the result.',
    ...
    heroBullets: [
      'Break down conversation dynamics',
      'Show 3 strong replies',
      'Suggest the next move',
    ],
    valueTitle: 'Why people use ReplyOS',
    valueText:
      'They do not want advice for the sake of advice. They want a better outcome: a reply, money, clarity, contact, calm, or control.',
    valuePoints: [
    ...
    analysisBlocks: [
      {
        title: 'Analysis',
        text: 'Interest, ignore risk, control balance, main mistake.',
      },
      {
        title: '3 replies',
        text: 'A selling reply, a confident reply, and a softer one.',
      },
      {
        title: 'Strategy',
        text: 'What to do now, when to wait, and when not to write.',
      },
    ],
...
> = {
  ru: {
    interest: 'Интерес',
    ignoreRisk: 'Риск игнора',
    controlBalance: 'Баланс контроля',
  },
  en: {
    interest: 'Interest',
...
function GlassCard({
  ...
  return (
    <div
      className={cn(
        'rounded-[28px] border border-white/10 bg-white/[0.04] shadow-[0_28px_120px_-40px_rgba(17,24,39,0.9)] backdrop-blur-2xl transition-transform duration-300 hover:-translate-y-1',
        className
      )}
    >
      {children}
...
function SectionLabel({
  ...
  return (
    <div
      className={cn(
        'text-[11px] uppercase tracking-[0.36em] text-white/45',
        className
      )}
    >
      {text}
...
function SmallPill({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center rounded-full border border-white/10 bg-white/[0.05] px-3 py-1 text-xs text-white/70">
      {children}
    </span>
  );
}
...
export default function Page() {
  ...
  useEffect(() => {
    localStorage.setItem('replyos_free_left', String(freeLeft));
  }, [freeLeft]);
  ...
  const currentNiche = useMemo(
    () => NICHES.find((item) => item.key === niche) ?? NICHES[0],
    [niche]
  );
  const currentGoal = useMemo(
    () => GOALS.find((item) => item.key === goal) ?? GOALS[0],
    [goal]
  );
  ...
  async function onAnalyze() {
    ...
    try {
      ...
      setError(
        resolvedLang === 'ru'
          ? 'Не удалось получить разбор. Проверь API и сеть.'
          : 'Could not get the analysis. Check the API and network.'
      );
    } finally {
      setLoading(false);
    }
  ...
  function setExampleText(example: Localized) {
    setText(tx(example, resolvedLang));
  }
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-5 md:px-6 lg:px-8">
        <header className="mb-8 flex flex-col gap-4 rounded-[28px] border border-white/10 bg-white/[0.035] px-5 py-4 backdrop-blur-2xl md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="rounded-full border border-white/10 bg-white/[0.05] px-4 py-2 text-xs text-white/70">
              {freeLeft} {ui.freeLeft}
            </div>

            <a
              href="#pricing"
              className="rounded-full border border-white/10 bg-white/[0.05] px-4 py-2 text-xs font-medium text-white/80 transition hover:bg-white/[0.08]"
            >
              {ui.secondaryCta}
            </a>
          </div>
        ...
        <section className="grid gap-8 pb-14 pt-6 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-7">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="#pricing"
                className="rounded-full border border-white/10 bg-white/[0.05] px-6 py-3 text-sm font-medium text-white/80 transition hover:bg-white/[0.08]"
              >
                {ui.secondaryCta}
              </a>
            </div>
          ...
          <div className="lg:col-span-5">
            <GlassCard className="p-6 lg:sticky lg:top-6">
              <div className="flex items-center justify-between">
                ...
                <SmallPill>{freeLeft > 0 ? `${freeLeft} free` : '0 free'}</SmallPill>
              </div>
              ...
              <div className="mt-6 space-y-5">
                ...
                <div className="rounded-[24px] border border-white/10 bg-white/[0.04] p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/65">
                    {resolvedLang === 'ru'
                      ? 'Пользователь должен за 15 секунд понять, что это про его проблему, что инструмент помогает и что он выглядит как премиальный SaaS.'
                      : 'The user must understand in 15 seconds that this solves their problem, works, and feels like a premium SaaS.'}
                  </p>
                </div>
              </div>
            </GlassCard>
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      setNiche(item.key);
                      if (!text.trim()) {
                        setText(tx(DEFAULT_TEXT[item.key], resolvedLang));
                      }
                    }}
                    className={cn(
                      'rounded-[24px] border p-5 text-left transition-all duration-200 hover:-translate-y-0.5',
                      active
                        ? 'border-cyan-300/40 bg-cyan-400/10 shadow-[0_0_40px_-20px_rgba(34,211,238,0.45)]'
                        : 'border-white/10 bg-black/20 hover:border-white/20'
                    )}
                  >
                    <div className="text-lg font-semibold">
                      {tx(item.title, resolvedLang)}
                    </div>
                    <div className="mt-2 text-sm text-white/60">
                      {tx(item.subtitle, resolvedLang)}
                    </div>
                    <div className="mt-4 text-xs uppercase tracking-[0.2em] text-cyan-200/90">
                      {tx(item.outcome, resolvedLang)}
                    </div>
                  </button>
                );
              })}
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'rounded-[24px] border p-5 text-left transition-all duration-200 hover:-translate-y-0.5',
                      active
                        ? 'border-white bg-white text-black shadow-[0_0_50px_-20px_rgba(255,255,255,0.45)]'
                        : 'border-white/10 bg-black/20 hover:border-white/20'
                    )}
                  >
                    <div className="text-base font-semibold">
                      {tx(item.label, resolvedLang)}
                    </div>
                    <div
                      className={cn(
                        'mt-2 text-sm',
          ...
          <GlassCard className="p-6 lg:col-span-7">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="text-sm text-white/55">
                {freeLeft > 0
                  ? `${ui.freeLeft}: ${freeLeft}`
                  : resolvedLang === 'ru'
                    ? 'Бесплатные разборы закончились.'
                    : 'Free analyses are finished.'}
              </div>
            </div>
            ...
            {result ? (
              <div className="mt-6 space-y-7">
                <div className="rounded-[28px] border border-cyan-300/20 bg-cyan-400/10 p-6">
                  ...
                  <div className="mt-3 text-sm text-cyan-50/85">
                    {ui.whyUserCameHereLabel}: {result.whyUserCameHere} · {ui.nextStepLabel}: {result.nextStep}
                  </div>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <MetricCard
                    ...
                    hint={resolvedLang === 'ru' ? 'Потенциал ответа' : 'Reply potential'}
                  />
                  <MetricCard
                    label={SCORE_LABELS[resolvedLang].ignoreRisk}
                    value={score ? score.ignoreRisk : '-'}
                    hint={resolvedLang === 'ru' ? 'Риск тишины' : 'Silence risk'}
                  />
                  <MetricCard
                    label={SCORE_LABELS[resolvedLang].controlBalance}
                    value={score ? score.controlBalance : '-'}
                    hint={resolvedLang === 'ru' ? 'Кто ведёт диалог' : 'Who leads the chat'}
                  />
                </div>
                ...
                <div className="grid gap-5 lg:grid-cols-12">
                  <div className="lg:col-span-5 space-y-4">
                      ...
                      <div className="mt-4 space-y-4">
                        <div>
                          <div className="text-sm uppercase tracking-[0.18em] text-white/40">
                            {INDICATOR_LABELS[resolvedLang].mainMistake}
                          </div>
                        ...
                        <div>
                          <div className="text-sm uppercase tracking-[0.18em] text-white/40">
                            {INDICATOR_LABELS[resolvedLang].psychologicalRead}
                          </div>
                          <p className="mt-2 text-sm leading-7 text-white/72">
                            {score?.psychologicalRead}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-[24px] border border-white/10 bg-black/20 p-5">
                      <div className="text-xs uppercase tracking-[0.24em] text-white/40">
                        {INDICATOR_LABELS[resolvedLang].confidence}
                      </div>
                      <div className="mt-4 flex items-end justify-between gap-4">
                        <div>
                          <div className="text-4xl font-semibold">
                            {Math.round(clamp(confidence, 0, 100))}%
                          </div>
                          <div className="mt-2 text-sm text-white/55">
                            {resolvedLang === 'ru' ? 'Насколько сильный прогноз' : 'How strong the forecast is'}
                          </div>
                        </div>
                        <SmallPill>
                          {confidence >= 80
                  ...
                  <div className="lg:col-span-7 space-y-4">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        ...
                        <h3 className="mt-2 text-2xl font-semibold">
                          {resolvedLang === 'ru' ? 'Три направления ответа' : 'Three reply directions'}
                        </h3>
                      </div>
                      <button
                        onClick={shareCurrentResult}
                        className="rounded-full border border-white/10 bg-white/[0.05] px-4 py-2 text-sm font-medium text-white/80 transition hover:bg-white/[0.08]"
                      >
                        {ui.shareResult}
                      </button>
                    </div>
                    ...
                    <div className="grid gap-4">
                      {replies.length > 0 ? (
                        ...
                        <div className="rounded-[24px] border border-white/10 bg-black/20 p-5 text-sm text-white/50">
                          {ui.noResult}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <StrategyCard
                        title={ui.doNowLabel}
                        text={result.strategy.doNow}
                      />
                      <StrategyCard
                        title={ui.ifNoReplyLabel}
                        text={result.strategy.ifNoReply}
                      />
                      <StrategyCard
                        title={ui.whenNotToWriteLabel}
                        text={result.strategy.whenNotToWrite}
                      />
                      <StrategyCard
                        title={ui.regainControlLabel}
                        text={result.strategy.regainControl}
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-6 grid gap-4 lg:grid-cols-2">
                <div className="rounded-[24px] border border-dashed border-white/12 bg-black/15 p-6 text-sm leading-7 text-white/45">
                  {resolvedLang === 'ru'
                    ? 'Здесь появится оценка диалога, уровень контроля, риск игнора, диагностика и 3 ответа.'
                    : 'This is where the score, control balance, ignore risk, diagnosis, and 3 reply options will appear.'}
                </div>
                <div className="rounded-[24px] border border-dashed border-white/12 bg-black/15 p-6 text-sm leading-7 text-white/45">
                  {resolvedLang === 'ru'
                    ? 'ReplyOS должен ощущаться как премиальный AI-инструмент, а не как шаблонный генератор текста.'
                    : 'ReplyOS should feel like a premium AI tool, not a generic text generator.'}
                </div>
              </div>
            )}
          </GlassCard>
        ...
        <section className="mt-12">
          <GlassCard className="p-6 md:p-8">
            ...
            <SectionTitle
              ...
              text={
                resolvedLang === 'ru'
                  ? 'Когда человек видит, что инструмент помогает в реальном исходе разговора, он понимает ценность без лишних объяснений.'
                  : 'When a user sees that the tool changes the outcome of a real conversation, value becomes obvious without extra explanation.'
              }
            />
        ...
        <section id="pricing" className="mt-12">
          <div className="mb-6">
            ...
            <SectionTitle
              title={
                resolvedLang === 'ru'
                  ? 'Модель оплаты, которая чувствуется честно'
                  : 'A pricing model that feels fair'
              }
              text={ui.pricingText}
            />
          </div>
        ...
        <section className="mt-12">
          <GlassCard className="p-6 md:p-8">
            ...
            <SectionTitle
              title={resolvedLang === 'ru' ? 'Ответы на частые вопросы' : 'Common questions'}
              text={
                resolvedLang === 'ru'
                  ? 'Чтобы человек не терялся, сайт должен отвечать на сомнения до оплаты.'
                  : 'The site should answer objections before purchase, so the user does not get lost.'
              }
            />
        ...
        <section className="mt-12 pb-14">
          <GlassCard className="grid gap-5 p-6 md:p-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:justify-end">
              ...
              <a
                href="#pricing"
                className="rounded-full border border-white/10 bg-white/[0.05] px-5 py-3 text-sm font-medium text-white/80 transition hover:bg-white/[0.08]"
              >
                {ui.startTeam}
              </a>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 px-4 backdrop-blur-md">
          <div className="w-full max-w-xl">
            <GlassCard className="p-6 md:p-8">
              ...
              <div className="mt-4 rounded-[22px] border border-white/10 bg-black/20 p-4 text-sm text-white/55">
                {ui.paywallCaption}
              </div>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                ...
                <button
                  ...
                  className="rounded-2xl border border-white/10 bg-white/[0.05] px-5 py-3 text-sm font-medium text-white/80"
                >
